 ...
 *   <li>Create n perturbed versions: x' = x + ÎµÂ·noise</li>
 ...
 * <p>Where:
 * <ul>
 *   <li>R âˆˆ [0, 1] (higher is more robust)</li>
 *   <li>Ï†(x) = attribution vector for instance x</li>
 *   <li>Îµ = perturbation magnitude</li>
 ...
 *     System.out.println("âœ… Explanations are robust");
 * } else {
 *     System.out.println("âš ï¸ Explanations may be unstable");
 * }
 * 
 ...
 * <tr><td>&gt; 0.95</td><td>Highly robust</td><td>âœ… Safe for production</td></tr>
 * <tr><td>0.85-0.95</td><td>Moderately robust</td><td>âš ï¸ Monitor in production</td></tr>
 * <tr><td>&lt; 0.85</td><td>Unstable</td><td>âŒ Investigate before deployment</td></tr>
 * </table>
 * 
 * <h2>Limitations</h2>
 * <ul>
 *   <li>Computational cost: O(n Ã— explainer_cost)</li>
 *   <li>Gaussian noise may not match real adversarial attacks</li>
 *   <li>Score depends on perturbation magnitude Îµ</li>
 * </ul>
 * 
 * @since 1.1.0-alpha
...
public class RobustnessScore {
    ...
    public enum PerturbationType {
        /** Gaussian noise: x' = x + N(0, Îµ) */
        GAUSSIAN,
        
        /** Uniform noise: x' = x + U(-Îµ, +Îµ) */
        UNIFORM,
    ...
    public record RobustnessReport(
        ...
        public String summary() {
            return String.format(
                ...
                "Mean Stability: %.3f Â± %.3f\n" +
                "Worst-case Drift: %.3f\n" +
                "Perturbations: %d Ã— %.1f%% noise (%s)\n" +
