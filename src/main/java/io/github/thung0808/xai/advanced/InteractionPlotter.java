 ...
 *   <li>Create 2D grid: f1 âˆˆ {v1, v2, ..., vn}, f2 âˆˆ {u1, u2, ..., um}</li>
 ...
 *     </ul>
 *   </li>
 *   <li>Return nÃ—m heatmap of averaged predictions</li>
 * </ol>
 * 
 * <p><b>Interaction Detection:</b></p>
 * <p>If PDP(f1=v, f2=u) â‰  PDP(f1=v) + PDP(f2=u) - baseline, then interaction exists.</p>
 * 
 * <p><b>Example:</b></p>
 * <p>Age Ã— Income interaction in loan approval:
