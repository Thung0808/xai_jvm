 ...
 * 
 * <h2>Algorithm</h2>
 * <p>For linear models: {@code prediction = w₀ + w₁x₁ + w₂x₂ + ... + wₙxₙ}
 * 
 * <p>The attribution for feature i is simply: <strong>φᵢ = wᵢ × xᵢ</strong>
 * 
 ...
 * );
 * 
 * // Latency: ~1μs (vs ~1000μs for PermutationExplainer)
 * System.out.println("Feature contributions: " + explanation.getAttributions());
 * }</pre>
 * 
 * <h2>When to Use</h2>
 * <ul>
 *   <li>✅ Linear models (coefficients available)</li>
 *   <li>✅ Need exact explanations (not approximations)</li>
 *   <li>✅ Ultra-low latency requirements (&lt;1μs)</li>
 *   <li>❌ Non-linear models → Use {@link PermutationExplainer} or {@link TreeExplainer}</li>
 * </ul>
 * 
 * <h2>Version Notes</h2>
...
public class LinearExplainer implements Explainer<PredictiveModel> {
    ...
    public Explanation explain(PredictiveModel model, double[] instance, ModelContext context) {
        ...
        // Build feature attributions (φᵢ = wᵢ × xᵢ)
